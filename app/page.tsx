...
for which we didn’t get any requests in the Arizona deployment.</p></section>
 ...
 <section className="text-center" style={{ marginTop: '2rem' }}>
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '150px', textAlign: 'center' }}>
    ...
    {/* <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <a href="www.linkedin.com/in/dhairyaMgajjar" target="_blank" className="text-decoration-none">
        <figure className="figure">
